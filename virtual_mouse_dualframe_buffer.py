    ...
    while True:
        ...
        if hands:
            ...
            if relative_lower_palm_aceleration < CLICK_ACELERATION_THRESHOLD:
                click_status = helper_functions.click_mechanics(relative_palm_index_thumb_distance, CLICK_DISTANCE, click_status, handType)
                
        elif click_status == 1:
            # Stop clicking when hands aren't in frame
            click_status = helper_functions.click_mechanics(CLICK_DISTANCE+1, CLICK_DISTANCE, click_status, handType)
